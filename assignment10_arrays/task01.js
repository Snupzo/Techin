...
// Using loop per task's instruction
...
if(counter > 0)
{
    console.log(`Waldo is found ${counter} time(s).`);
    console.log(`Array indexes of Waldo: ${arrayPosition.toString()}`);
}
else
{
    console.log(`Waldo has not been found.`);
}